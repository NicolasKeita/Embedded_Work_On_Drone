/*
Filename: Src/Embedded/Hil/HilTelemetry.cpp
...
HilSensorSample make_sensor_sample(std::float64_t time_s, const FlightCore::HAL::SensorData& sensor,
...
void HilTelemetryRecorder::maybe_record(std::float64_t time_s, const AircraftState& truth,
