...
selects one scenario (engine-level suite: NOMINAL-001, FAULT_INJECTOR-001..004; physics
and autonomous catalog: NOMINAL-002..010) and --all sweeps every deterministic scenario.
