...
private:
    ...
    static void record_run_start(RunContext&);
    static void record_run_end(RunContext&);
    static void record_fc1_failure(RunContext&);
    ...
    static void record_fault_cleared(RunContext&);
