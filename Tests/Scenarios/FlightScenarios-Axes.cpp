...
Description: Implementation of the autonomous axis scenarios (MC-001 to MC-003).
...
/*
MC-001_AltitudeHold: autonomous altitude loop from the ground up to 100 m;
...
{
    runner.begin_scenario("MC-001_AltitudeHold", "Autonomous altitude hold (z: 0 -> 100 m)");
    runner.log_header();
...
/*
MC-002_PositionXHold: cascaded X position -> pitch -> servos. Phase 1:
...
{
    runner.begin_scenario("MC-002_PositionXHold", "Autonomous cascaded X axis (x: 20 -> 0 m)");
    runner.log_header();
...
/*
MC-003_PositionYHold: cascaded Y position -> roll -> servos. Phase 1:
...
{
    runner.begin_scenario("MC-003_PositionYHold", "Autonomous cascaded Y axis (y: -15 -> 0 m)");
    runner.log_header();
