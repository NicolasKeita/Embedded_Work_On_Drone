...
> artifacts — `./hil_runner --scenario HIL-001` and `./hil_runner --scenario HIL-002`.

## HIL-001 — nominal station keeping
...
## HIL-002 — FC1 failure during station keeping

```
============================================
HIL-002 : fault injection scenario
============================================
